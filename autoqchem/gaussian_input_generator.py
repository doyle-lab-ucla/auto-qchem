...
class gaussian_input_generator(object):
    ...
    def __init__(self, molecule, directory):
    ...
    def create_gaussian_files(self, workflow=gaussian_workflows.equilibrium) -> list:
        ...
        # evaluate workflow
        tasks = tuple(val(self.basis_set) for val in workflow.value)
    ...
    def __generate_file(self, tasks, name, fs_name, resource_block, coords_block,
